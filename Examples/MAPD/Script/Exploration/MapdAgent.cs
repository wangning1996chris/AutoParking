...
public class MapdAgent : Agent
{
    ...
    public override void OnActionReceived(ActionBuffers actionBuffers)
    {
        ...
        m_MyArea.AddGroupRewardAsValue((p_dist - t_dist) * 100);
    ...
    public void IsEndEpisode()
    {
        ...
        {
            Debug.Log("success");
            m_MyArea.AddGroupRewardAsValue(100f);
            m_MyArea.SetGoalPos(Goal);
        }
        ...
        for (int i = 0; i < RayNum-1; i ++)
        {
            ...
            {
                Debug.Log("collision");
                m_MyArea.AddGroupRewardAsValue(-1f);
            }
        }
    }
}
